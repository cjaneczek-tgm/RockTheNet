...
public class ReaderTest {
	...
	SNMPv2Reader v2Reader = new SNMPv2Reader("Firewall", new File(
			"mib/NS-POLICY.mib"), "10.0.100.10", "5xHIT", "udp");
	SNMPv3Reader v3Reader = new SNMPv3Reader("Firewall", new File(
			"mib/NS-POLICY.mib"), "10.0.100.10", "5xHIT", "udp");
